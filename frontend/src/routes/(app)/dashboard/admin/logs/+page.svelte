...
<div class="space-y-6">
	<PageHeader title="Audit Logy" description="Historie všech akcí v systému" />
						...
						<div class="flex items-center justify-between">
							<div class="min-w-0 flex-1">
								<div class="flex items-center space-x-3">
									<span
										class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium {getActionColor(
											log.action
										)}"
									>
										{log.action}
