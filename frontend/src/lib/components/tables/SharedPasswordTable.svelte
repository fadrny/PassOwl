<script lang="ts">
	...
	const decryptedPasswordIds = $derived(new Set(Array.from(decryptedSharedPasswords.keys())));
...
<div class="overflow-hidden bg-white shadow sm:rounded-md">
	...
	{:else if sharedPasswords.length === 0}
		<div class="py-12 text-center">
			...
			<p class="mt-1 text-sm text-gray-500">Zatím s vámi nikdo nesdílel žádná hesla.</p>
		</div>
	{:else}
