...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
	...
	auth = {
		 ...
		 */
		registerUserAuthRegisterPost: (data: UserCreate, params: RequestParams = {}) =>
	...
	users = {
		 ...
		 * @secure
		 */
		updateUserAvatarUsersMeAvatarPut: (data: UserUpdate, params: RequestParams = {}) =>
			this.request<User, HTTPValidationError>({
	...
	credentials = {
		 ...
		 * @secure
		 */
		createCredentialCredentialsPost: (data: CredentialCreate, params: RequestParams = {}) =>
		 ...
		 * @secure
		 */
		getCredentialCredentialsCredentialIdGet: (credentialId: number, params: RequestParams = {}) =>
			this.request<Credential, HTTPValidationError>({
	...
	secureNotes = {
		 ...
		 * @secure
		 */
		createSecureNoteSecureNotesPost: (data: SecureNoteCreate, params: RequestParams = {}) =>
		 ...
		 * @secure
		 */
		getSecureNoteSecureNotesNoteIdGet: (noteId: number, params: RequestParams = {}) =>
			this.request<SecureNote, HTTPValidationError>({
		 ...
		 * @secure
		 */
		deleteSecureNoteSecureNotesNoteIdDelete: (noteId: number, params: RequestParams = {}) =>
			this.request<any, HTTPValidationError>({
				path: `/secure-notes/${noteId}`,
				method: 'DELETE',
				secure: true,
	...
	categories = {
		 ...
		 * @secure
		 */
		createCategoryCategoriesPost: (data: PasswordCategoryCreate, params: RequestParams = {}) =>
		 ...
		 * @secure
		 */
		getCategoryCategoriesCategoryIdGet: (categoryId: number, params: RequestParams = {}) =>
			this.request<PasswordCategory, HTTPValidationError>({
		 ...
		 * @secure
		 */
		deleteCategoryCategoriesCategoryIdDelete: (categoryId: number, params: RequestParams = {}) =>
			this.request<any, HTTPValidationError>({
				path: `/categories/${categoryId}`,
				method: 'DELETE',
				secure: true,
